...
mixin _$Order {
 ...
 String get id;@JsonKey(name: 'store_id') String get storeId;@JsonKey(name: 'order_number') String get orderNumber;@JsonKey(name: 'employee_id') String? get employeeId;@JsonKey(name: 'terminal_id') String? get terminalId;@JsonKey(name: 'table_id') String? get tableId;@JsonKey(name: 'order_type') String get orderType; String get status;@JsonKey(name: 'discount_amount') double get discountAmount; double get subtotal;@JsonKey(name: 'tax_amount') double get taxAmount;@JsonKey(name: 'service_charge') double get serviceCharge;@JsonKey(name: 'grand_total') double get grandTotal;@JsonKey(name: 'payment_status') String get paymentStatus; String? get notes;@JsonKey(name: 'created_at') DateTime? get createdAt;@JsonKey(name: 'updated_at') DateTime? get updatedAt; List<OrderItem> get items;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,storeId,orderNumber,employeeId,terminalId,tableId,orderType,status,discountAmount,subtotal,taxAmount,serviceCharge,grandTotal,paymentStatus,notes,createdAt,updatedAt,const DeepCollectionEquality().hash(items));

@override
String toString() {
  return 'Order(id: $id, storeId: $storeId, orderNumber: $orderNumber, employeeId: $employeeId, terminalId: $terminalId, tableId: $tableId, orderType: $orderType, status: $status, discountAmount: $discountAmount, subtotal: $subtotal, taxAmount: $taxAmount, serviceCharge: $serviceCharge, grandTotal: $grandTotal, paymentStatus: $paymentStatus, notes: $notes, createdAt: $createdAt, updatedAt: $updatedAt, items: $items)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'store_id') String storeId,@JsonKey(name: 'order_number') String orderNumber,@JsonKey(name: 'employee_id') String? employeeId,@JsonKey(name: 'terminal_id') String? terminalId,@JsonKey(name: 'table_id') String? tableId,@JsonKey(name: 'order_type') String orderType, String status,@JsonKey(name: 'discount_amount') double discountAmount, double subtotal,@JsonKey(name: 'tax_amount') double taxAmount,@JsonKey(name: 'service_charge') double serviceCharge,@JsonKey(name: 'grand_total') double grandTotal,@JsonKey(name: 'payment_status') String paymentStatus, String? notes,@JsonKey(name: 'created_at') DateTime? createdAt,@JsonKey(name: 'updated_at') DateTime? updatedAt, List<OrderItem> items
});
...
/// Create a copy of Order
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? storeId = null,Object? orderNumber = null,Object? employeeId = freezed,Object? terminalId = freezed,Object? tableId = freezed,Object? orderType = null,Object? status = null,Object? discountAmount = null,Object? subtotal = null,Object? taxAmount = null,Object? serviceCharge = null,Object? grandTotal = null,Object? paymentStatus = null,Object? notes = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? items = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'store_id')  String storeId, @JsonKey(name: 'order_number')  String orderNumber, @JsonKey(name: 'employee_id')  String? employeeId, @JsonKey(name: 'terminal_id')  String? terminalId, @JsonKey(name: 'table_id')  String? tableId, @JsonKey(name: 'order_type')  String orderType,  String status, @JsonKey(name: 'discount_amount')  double discountAmount,  double subtotal, @JsonKey(name: 'tax_amount')  double taxAmount, @JsonKey(name: 'service_charge')  double serviceCharge, @JsonKey(name: 'grand_total')  double grandTotal, @JsonKey(name: 'payment_status')  String paymentStatus,  String? notes, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt,  List<OrderItem> items)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Order() when $default != null:
return $default(_that.id,_that.storeId,_that.orderNumber,_that.employeeId,_that.terminalId,_that.tableId,_that.orderType,_that.status,_that.discountAmount,_that.subtotal,_that.taxAmount,_that.serviceCharge,_that.grandTotal,_that.paymentStatus,_that.notes,_that.createdAt,_that.updatedAt,_that.items);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'store_id')  String storeId, @JsonKey(name: 'order_number')  String orderNumber, @JsonKey(name: 'employee_id')  String? employeeId, @JsonKey(name: 'terminal_id')  String? terminalId, @JsonKey(name: 'table_id')  String? tableId, @JsonKey(name: 'order_type')  String orderType,  String status, @JsonKey(name: 'discount_amount')  double discountAmount,  double subtotal, @JsonKey(name: 'tax_amount')  double taxAmount, @JsonKey(name: 'service_charge')  double serviceCharge, @JsonKey(name: 'grand_total')  double grandTotal, @JsonKey(name: 'payment_status')  String paymentStatus,  String? notes, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt,  List<OrderItem> items)  $default,) {final _that = this;
switch (_that) {
case _Order():
return $default(_that.id,_that.storeId,_that.orderNumber,_that.employeeId,_that.terminalId,_that.tableId,_that.orderType,_that.status,_that.discountAmount,_that.subtotal,_that.taxAmount,_that.serviceCharge,_that.grandTotal,_that.paymentStatus,_that.notes,_that.createdAt,_that.updatedAt,_that.items);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'store_id')  String storeId, @JsonKey(name: 'order_number')  String orderNumber, @JsonKey(name: 'employee_id')  String? employeeId, @JsonKey(name: 'terminal_id')  String? terminalId, @JsonKey(name: 'table_id')  String? tableId, @JsonKey(name: 'order_type')  String orderType,  String status, @JsonKey(name: 'discount_amount')  double discountAmount,  double subtotal, @JsonKey(name: 'tax_amount')  double taxAmount, @JsonKey(name: 'service_charge')  double serviceCharge, @JsonKey(name: 'grand_total')  double grandTotal, @JsonKey(name: 'payment_status')  String paymentStatus,  String? notes, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt,  List<OrderItem> items)?  $default,) {final _that = this;
switch (_that) {
case _Order() when $default != null:
return $default(_that.id,_that.storeId,_that.orderNumber,_that.employeeId,_that.terminalId,_that.tableId,_that.orderType,_that.status,_that.discountAmount,_that.subtotal,_that.taxAmount,_that.serviceCharge,_that.grandTotal,_that.paymentStatus,_that.notes,_that.createdAt,_that.updatedAt,_that.items);case _:
  return null;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,storeId,orderNumber,employeeId,terminalId,tableId,orderType,status,discountAmount,subtotal,taxAmount,serviceCharge,grandTotal,paymentStatus,notes,createdAt,updatedAt,const DeepCollectionEquality().hash(_items));
...
/// Create a copy of Order
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? storeId = null,Object? orderNumber = null,Object? employeeId = freezed,Object? terminalId = freezed,Object? tableId = freezed,Object? orderType = null,Object? status = null,Object? discountAmount = null,Object? subtotal = null,Object? taxAmount = null,Object? serviceCharge = null,Object? grandTotal = null,Object? paymentStatus = null,Object? notes = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? items = null,}) {
  return _then(_Order(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,storeId: null == storeId ? _self.storeId : storeId // ignore: cast_nullable_to_non_nullable
as String,orderNumber: null == orderNumber ? _self.orderNumber : orderNumber // ignore: cast_nullable_to_non_nullable
...
mixin _$OrderItem {
 ...
 String get id;@JsonKey(name: 'order_id') String get orderId;@JsonKey(name: 'product_id') String get productId;@JsonKey(name: 'product_name') String get productName; int get quantity; double get price;@JsonKey(name: 'tax_amount') double get taxAmount; double get total; String? get notes; List<OrderItemModifier> get modifiers;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OrderItem&&(identical(other.id, id) || other.id == id)&&(identical(other.orderId, orderId) || other.orderId == orderId)&&(identical(other.productId, productId) || other.productId == productId)&&(identical(other.productName, productName) || other.productName == productName)&&(identical(other.quantity, quantity) || other.quantity == quantity)&&(identical(other.price, price) || other.price == price)&&(identical(other.taxAmount, taxAmount) || other.taxAmount == taxAmount)&&(identical(other.total, total) || other.total == total)&&(identical(other.notes, notes) || other.notes == notes)&&const DeepCollectionEquality().equals(other.modifiers, modifiers));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,orderId,productId,productName,quantity,price,taxAmount,total,notes,const DeepCollectionEquality().hash(modifiers));

@override
String toString() {
  return 'OrderItem(id: $id, orderId: $orderId, productId: $productId, productName: $productName, quantity: $quantity, price: $price, taxAmount: $taxAmount, total: $total, notes: $notes, modifiers: $modifiers)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'order_id') String orderId,@JsonKey(name: 'product_id') String productId,@JsonKey(name: 'product_name') String productName, int quantity, double price,@JsonKey(name: 'tax_amount') double taxAmount, double total, String? notes, List<OrderItemModifier> modifiers
});
...
/// Create a copy of OrderItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? orderId = null,Object? productId = null,Object? productName = null,Object? quantity = null,Object? price = null,Object? taxAmount = null,Object? total = null,Object? notes = freezed,Object? modifiers = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'order_id')  String orderId, @JsonKey(name: 'product_id')  String productId, @JsonKey(name: 'product_name')  String productName,  int quantity,  double price, @JsonKey(name: 'tax_amount')  double taxAmount,  double total,  String? notes,  List<OrderItemModifier> modifiers)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OrderItem() when $default != null:
return $default(_that.id,_that.orderId,_that.productId,_that.productName,_that.quantity,_that.price,_that.taxAmount,_that.total,_that.notes,_that.modifiers);case _:
  return orElse();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _OrderItem&&(identical(other.id, id) || other.id == id)&&(identical(other.orderId, orderId) || other.orderId == orderId)&&(identical(other.productId, productId) || other.productId == productId)&&(identical(other.productName, productName) || other.productName == productName)&&(identical(other.quantity, quantity) || other.quantity == quantity)&&(identical(other.price, price) || other.price == price)&&(identical(other.taxAmount, taxAmount) || other.taxAmount == taxAmount)&&(identical(other.total, total) || other.total == total)&&(identical(other.notes, notes) || other.notes == notes)&&const DeepCollectionEquality().equals(other._modifiers, _modifiers));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,orderId,productId,productName,quantity,price,taxAmount,total,notes,const DeepCollectionEquality().hash(_modifiers));
...
/// Create a copy of OrderItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? orderId = null,Object? productId = null,Object? productName = null,Object? quantity = null,Object? price = null,Object? taxAmount = null,Object? total = null,Object? notes = freezed,Object? modifiers = null,}) {
...
@JsonKey(name: 'store_id') String get storeId;@JsonKey(name: 'employee_id') String? get employeeId;@JsonKey(name: 'terminal_id') String? get terminalId;@JsonKey(name: 'table_id') String? get tableId;@JsonKey(name: 'order_type') String get orderType;@JsonKey(name: 'discount_amount') double get discountAmount; String? get notes; List<OrderItemCreate> get items;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,storeId,employeeId,terminalId,tableId,orderType,discountAmount,notes,const DeepCollectionEquality().hash(items));

@override
String toString() {
  return 'OrderCreate(storeId: $storeId, employeeId: $employeeId, terminalId: $terminalId, tableId: $tableId, orderType: $orderType, discountAmount: $discountAmount, notes: $notes, items: $items)';
}
...
@useResult
$Res call({
@JsonKey(name: 'store_id') String storeId,@JsonKey(name: 'employee_id') String? employeeId,@JsonKey(name: 'terminal_id') String? terminalId,@JsonKey(name: 'table_id') String? tableId,@JsonKey(name: 'order_type') String orderType,@JsonKey(name: 'discount_amount') double discountAmount, String? notes, List<OrderItemCreate> items
});
...
/// Create a copy of OrderCreate
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? storeId = null,Object? employeeId = freezed,Object? terminalId = freezed,Object? tableId = freezed,Object? orderType = null,Object? discountAmount = null,Object? notes = freezed,Object? items = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'store_id')  String storeId, @JsonKey(name: 'employee_id')  String? employeeId, @JsonKey(name: 'terminal_id')  String? terminalId, @JsonKey(name: 'table_id')  String? tableId, @JsonKey(name: 'order_type')  String orderType, @JsonKey(name: 'discount_amount')  double discountAmount,  String? notes,  List<OrderItemCreate> items)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OrderCreate() when $default != null:
return $default(_that.storeId,_that.employeeId,_that.terminalId,_that.tableId,_that.orderType,_that.discountAmount,_that.notes,_that.items);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'store_id')  String storeId, @JsonKey(name: 'employee_id')  String? employeeId, @JsonKey(name: 'terminal_id')  String? terminalId, @JsonKey(name: 'table_id')  String? tableId, @JsonKey(name: 'order_type')  String orderType, @JsonKey(name: 'discount_amount')  double discountAmount,  String? notes,  List<OrderItemCreate> items)  $default,) {final _that = this;
switch (_that) {
case _OrderCreate():
return $default(_that.storeId,_that.employeeId,_that.terminalId,_that.tableId,_that.orderType,_that.discountAmount,_that.notes,_that.items);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'store_id')  String storeId, @JsonKey(name: 'employee_id')  String? employeeId, @JsonKey(name: 'terminal_id')  String? terminalId, @JsonKey(name: 'table_id')  String? tableId, @JsonKey(name: 'order_type')  String orderType, @JsonKey(name: 'discount_amount')  double discountAmount,  String? notes,  List<OrderItemCreate> items)?  $default,) {final _that = this;
switch (_that) {
case _OrderCreate() when $default != null:
return $default(_that.storeId,_that.employeeId,_that.terminalId,_that.tableId,_that.orderType,_that.discountAmount,_that.notes,_that.items);case _:
  return null;
...
class _OrderCreate implements OrderCreate {
  const _OrderCreate({@JsonKey(name: 'store_id') required this.storeId, @JsonKey(name: 'employee_id') this.employeeId, @JsonKey(name: 'terminal_id') this.terminalId, @JsonKey(name: 'table_id') this.tableId, @JsonKey(name: 'order_type') this.orderType = 'dine_in', @JsonKey(name: 'discount_amount') this.discountAmount = 0, this.notes, required final  List<OrderItemCreate> items}): _items = items;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,storeId,employeeId,terminalId,tableId,orderType,discountAmount,notes,const DeepCollectionEquality().hash(_items));
...
/// Create a copy of OrderCreate
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? storeId = null,Object? employeeId = freezed,Object? terminalId = freezed,Object? tableId = freezed,Object? orderType = null,Object? discountAmount = null,Object? notes = freezed,Object? items = null,}) {
